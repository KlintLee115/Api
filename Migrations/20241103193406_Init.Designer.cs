            ...
            modelBuilder.Entity("Api.Model.People.Customer", b =>
                {
                    ...
                    b.HasOne("Api.Model.FinancialInfo", "Finances")
                        .WithOne("Customer")
                        .HasForeignKey("Api.Model.People.Customer", "FinancialInfo")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
